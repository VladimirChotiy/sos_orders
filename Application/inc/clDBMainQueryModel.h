...
private:
    ...
    const QString queryText {"SELECT tbl_requests.id AS reqid, tbl_requests.context, tbl_requests.comment, tbl_types.name AS typename, tbl_objects.name AS objname, tbl_objects.address, tbl_person.name AS persname, tbl_person.telephone, tbl_person.email, tbl_changes.date, tbl_status.name AS statusname, tbl_users.disp_name FROM tbl_requests " \
